 ...
 */
@Repository
public class UpreportLogDao extends BaseDao<UpreportLog> {
	 ...
	 * @return
	 */
	public UpreportLog getByField(String fieldName, String value) {
	 ...
	 * @return
	 */
	public Page<UpreportLog> getCmlUpreportLogPageByParams(Page<UpreportLog> page,
			Map<String, String> params) {
		Map<String, Object> param = new HashMap<String, Object>();
		StringBuffer hql = new StringBuffer(" from CmlUpreportLog tb ");
		if (params != null) {
			hql.append(WHERE);
